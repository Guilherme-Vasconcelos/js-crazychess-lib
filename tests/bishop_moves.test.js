...
test('Bishops valid general movements with simple position', () => {
    const board = new Board('b6b/8/8/8/8/8/8/B6B b - - 0 1', true);
    const moves = [
...
test('Bishops valid general movements with more pieces and randomly placed', () => {
    const board = new Board('2B1b3/8/3BBb1b/1Bb5/4BB2/2b1b3/2B4b/6B1 w - - 0 1', true);
    const moves = [
...
test('Invalid white bishops moves', () => {
    const board = new Board('2B1b3/2B2bB1/B1b3b1/4b3/3b1B2/2B5/2B3b1/7B w - - 0 1', true);
    const moves = [
...
test('Invalid black bishops moves', () => {
    const board = new Board('3b3b/1bB3B1/4Bb2/2bB1B2/1b2b1b1/2B2B2/1b2B1b1/3b4 b - - 0 1', true);
    const moves = [

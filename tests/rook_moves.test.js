...
test('Rooks valid general movements with more pieces and randomly placed', () => {
    const board = new Board({
        FEN: 'R6r/4R3/2r2R2/1r6/2R5/8/2R2r2/R6r b - - 0 1', checkless: true
    });
    const moves = [
...
test('Invalid white rooks moves', () => {
    const board = new Board({
        FEN: '1R5r/2R1R3/4rr2/1r2r3/2R5/8/6R1/R5R1 w - - 0 1', checkless: true
    });
    const moves = [
...
test('Invalid black rooks moves', () => {
    const board = new Board({
        FEN: '3R4/4r1r1/2r3R1/2R1r3/1r1rR3/3R4/8/4r3 b - - 0 1', checkless: true
    });
    const moves = [
